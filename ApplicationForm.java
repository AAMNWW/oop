...
public class ApplicationForm extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("Application Form - Matte Black Theme");

        // Banner
        BorderPane bannerPane = new BorderPane();
        bannerPane.setStyle("-fx-background-color: #121212; -fx-padding: 15px;");

        Text bannerText = new Text("Application Form");
        bannerText.setFont(Font.font("Arial", FontWeight.BOLD, 28));
        ...
        formGrid.setHgap(10);
        formGrid.setVgap(10);
        formGrid.setStyle("-fx-background-color: #1E1E1E; -fx-border-color: #3C3C3C; -fx-border-radius: 10px; -fx-padding: 20px;");
        ...
        styleInput(addressArea); // Styled TextArea to match matte black theme.
        ...
        imageView.setStyle("-fx-border-color: #3C3C3C;");
    ...
    private void showDataScreen() {
        ...
        dataLayout.setStyle("-fx-background-color: #1E1E1E;");

        Label dataLabel = new Label("Submitted Data:");
        dataLabel.setStyle("-fx-font-size: 18px; -fx-font-weight: bold; -fx-text-fill: white;");
        ...
        for (String[] entry : submittedData) {
            ...
            entryLabel.setStyle("-fx-background-color: #3C3C3C; -fx-text-fill: white; -fx-padding: 10px;");
    ...
    private void styleInput(Control control) {
        control.setStyle("-fx-background-color: #3C3C3C; -fx-text-fill: white; -fx-border-color: #5C5C5C;");
    }

    private void styleButton(Button button) {
        button.setStyle("-fx-background-color: #3C3C3C; -fx-text-fill: white; -fx-font-weight: bold;");
    }
